(function(){
  ...
  //d3.json("Regions.aspx")
    ...
    .get(function(error, rows){makePolygons(rows, {color:"blue",weight:.5,opacity:0.05});});

  //d3.json("Ports.aspx")
    //.row(function(d){return d;})
    d3.json("data/ports.json")
    .get(function(error, rows){ makePolygons(rows, {color:"purple",weight:2,opacity:0.65}); });
